...
//                || role == UserRole.MANAGER) {
        ...
        if (user.canUpdateDonationsAt(model.getCurrentLocation())) {
        ...
        ab.setTitle(model.getCurrentLocationName());
...
//            SearchableList locationList = Model.getInstance().locationList;
            List<Donation> donationList = model.getCurrentLocationDonations();
    ...
    private void setupRecyclerView(@NonNull RecyclerView recyclerView) {
        ...
        recyclerView.setAdapter(new InventoryActivity.SimpleItemRecyclerViewAdapter(
                model.getCurrentLocationDonations()));
    }
